...
// typed tab enum + router object for the Home/Discover/Subscriptions/History/Settings
// sidebar-adaptable TabView. Search is a child route inside Discover. The
// router also owns per-tab NavigationPath so Subscriptions' push-to-episode-list
...
enum TVTab: String, CaseIterable, Identifiable {
    ...
    var title: String {
        ...
        case .library: return "Subscriptions"
