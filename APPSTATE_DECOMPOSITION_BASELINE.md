> **SUPERSEDED — historical record only.** A newer point-in-time assessment is `ASSESSMENT_2026-08-30.md`; it is also a snapshot, not current runtime truth. Do not cite figures from this file as current.
