...
| **Listening History** | `ListeningHistoryView` | Page (Menu or App Settings) | Log of all episodes listened to, with duration and date. Grouped by time period. Minimum 60s playback threshold. Swipe actions mirror Podcast Detail: Play / Play Next on the leading edge, and a far-right Download/Archive/Unarchive action plus Play Last on the trailing edge. |
