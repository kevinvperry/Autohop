...
| **App Settings** | `SettingsView` | Page | Global app configuration — Release Radar, Auto Archive, download behaviour, controls, global Default Playback, notifications, OPML import/export, and opt-in iCloud Sync. |
