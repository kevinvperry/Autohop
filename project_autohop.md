...
- Organisation: Priority Stack, Up Next, Play Next, Play Last, archive/unarchive,
  ...
  and stats.
- Background work: BGAppRefreshTask + BGProcessingTask feed refresh, Release Radar
  protected background slots, foreground/background-audio feed polling, and background
