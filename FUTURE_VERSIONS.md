...
- 💡 **Optional dark/tinted icon variants** — Apple does not require separate variants;
  iOS auto-generates tinted appearances from the supplied icon. Revisit only if the
  auto-generated dark/tinted home-screen versions need extra polish after device QA.
